...
The general workflow is:
  ...
  5. Create composite B0/B1's: `sh dwi-recon-pipeline/createB0B1.sh [B0 Crop]` \
  \
For the final steps you will require a couple files from the T2 reconstruction.
  ...
  7. Register B0B1 to T2 space: `sh /fileserver/fetal/scripts/DTIfetal/registerB0B1toT2-multi.sh [b0b1/dwi_b0_SUBJID.nii.gz]`
  8. Review registration attempts and note the best registration to t2_t2 found in `t2/`
  9. Compute tensor image: sh dwi-recon-pipeline/doSVRandTensorCompute.sh `[b0b1/dwi_b0_SUBJID.nii.gz] [SERVER] [BEST ALIGNMENT SUFFIX]`
