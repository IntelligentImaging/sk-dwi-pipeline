...
Requires access to CRKIT, dcm2niix, fsl (for fslsplit), and TVtool (for generating RGB).
...
You will require a couple files from the T2 reconstruction. Find T2 recon folder.
